"""
Gioco Pong. Non e' concluso, e' incompleto, pero' e' a un buon punto. La schermata
di 'congratulazioni' e' in fase di sviluppo.
"""
...
class Pong:
    ...
    def __init__(self):
        ...
        self.velocitaRacchettaSingolo = 2.8  #2.9 o 3 aumenta il livello di difficolta'
        ...
        self.goal = 11  #punteggio obiettivo
